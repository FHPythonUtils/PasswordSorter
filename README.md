...
[![PyPI Downloads](https://img.shields.io/pypi/dm/passwordsorter.svg?style=for-the-badge)](https://pypistats.org/packages/passwordsorter)
[![PyPI Total Downloads](https://img.shields.io/badge/dynamic/json?style=for-the-badge&label=total%20downloads&query=%24.total_downloads&url=https%3A%2F%2Fapi.pepy.tech%2Fapi%2Fprojects%2Fpasswordsorter)](https://pepy.tech/project/passwordsorter)
...
```bash
$ git clone https://github.com/FHPythonUtils/PasswordSorter
```
